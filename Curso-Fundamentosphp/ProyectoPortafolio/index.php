...
$per = new persona('yukitera','Developer VB6');
...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      ...
      <div class="col">
        <h1><?php echo ($per->getName()); ?></h1>
        <h2><?php echo ($per->profesion); ?></h2>
        <ul>
          <li>Mail: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8ee6ebedfae1fccee3efe7e2a0ede1e3">[email&#160;protected]</a></li>
